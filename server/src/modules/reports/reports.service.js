...
export async function generateReportPDF(startDate, endDate) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const drawHeader = (title) => {
      doc.fillColor(slate900).font('Helvetica-Bold').fontSize(18).text('Relatório Consolidado ALEM', 36, 36);
