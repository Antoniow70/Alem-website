...
import { getVolunteers, updateVolunteerStatus } from '../server/src/modules/voluntarios/voluntarios.service.js';
...
async function testUpdate() {
  try {
    ...
    // Reverter o estado para o original para não alterar dados de produção/teste
