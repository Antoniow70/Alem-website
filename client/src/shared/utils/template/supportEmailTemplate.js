...
/**
 * Gera o template de e-mail em HTML para confirmação de pedido de apoio.
 * 
 * @param {object} data - Dados da submissão de suporte
...
export function getSupportEmailHtml(data) {
  ...
  const contentHtml = `
    ...
    <p style="margin-bottom: 24px;">Olá <strong>${data.name}</strong>,</p>
    <p style="margin-bottom: 24px;">Confirmamos que a ALEM recebeu o seu pedido de apoio com sucesso. A nossa equipa de assistência social irá analisar a informação partilhada com o máximo cuidado e atenção.</p>
    ...
    <div style="background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px; margin-bottom: 28px;">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 14px;">
        <tr>
          ...
          <td style="padding: 6px 0; color: #1E293B; font-weight: bold;">${data.tipo_necessidade || data.subject || 'Não especificado'}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" style="padding-top: 16px; border-top: 1px solid #E2E8F0; color: #64748B; font-weight: 600; padding-bottom: 6px;">Descrição do Pedido:</td>
        </tr>
        <tr>
    ...
    <p style="margin-bottom: 24px;">O nosso tempo médio de resposta é de 3 a 5 dias úteis. Entraremos em contacto através dos meios fornecidos (telefone ou e-mail) assim que a análise for concluída.</p>
