...
const UnicefLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-brand-poloBlue fill-current" aria-label="UNICEF Logo">
    ...
    <text x="68" y="38" className="font-sans font-extrabold text-2xl tracking-tight text-brand-bigStone dark:text-white">unicef</text>
    <text x="68" y="48" className="font-sans font-medium text-[8px] tracking-[0.2em] text-brand-poloBlue uppercase">Mocambique</text>
  </svg>
);
...
const UniZambezeLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-yellow-500 fill-current" aria-label="UniZambeze Logo">
    ...
    <text x="31" y="27" className="font-sans font-bold text-xs text-brand-bigStone dark:text-white">UZ</text>
    <text x="62" y="32" className="font-sans font-extrabold text-[15px] tracking-wide text-brand-bigStone dark:text-white">UniZambeze</text>
...
const MinedhLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-feedback-success fill-current" aria-label="MINEDH Logo">
    ...
    <text x="65" y="28" className="font-sans font-black text-sm tracking-wider text-brand-bigStone dark:text-white">MINEDH</text>
    ...
    <text x="65" y="48" className="font-sans font-medium text-[6px] tracking-[0.05em] text-brand-eastBay dark:text-dark-muted uppercase">e Desenvolvimento Humano</text>
  </svg>
);

// Custom SVG Logo for FDC (Fundacao para o Desenvolvimento da Comunidade)
const FdcLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-feedback-error fill-current" aria-label="FDC Logo">
    ...
    <text x="65" y="32" className="font-sans font-black text-xl tracking-widest text-brand-bigStone dark:text-white">FDC</text>
    ...
    <text x="65" y="51" className="font-sans font-medium text-[6px] tracking-[0.1em] text-brand-eastBay dark:text-dark-muted uppercase">da Comunidade</text>
  </svg>
);
...
const AdemoLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-purple-500 fill-current" aria-label="ADEMO Logo">
    ...
    <text x="62" y="31" className="font-sans font-extrabold text-lg tracking-wider text-brand-bigStone dark:text-white">ADEMO</text>
    ...
    <text x="62" y="50" className="font-sans font-medium text-[6px] tracking-[0.1em] text-brand-eastBay dark:text-dark-muted uppercase">de Mocambique</text>
  </svg>
);
