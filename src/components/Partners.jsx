...
// Custom SVG Logo for UNICEF Moçambique
const UnicefLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-blue-400 fill-current" aria-label="UNICEF Logo">
    ...
    {/* Stylized Mother & Child Silhouette */}
    ...
    <text x="68" y="48" className="font-sans font-medium text-[8px] tracking-[0.2em] text-blue-400 uppercase">Moçambique</text>
  </svg>
);
...
const UniZambezeLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-yellow-500 fill-current" aria-label="UniZambeze Logo">
    ...
    {/* Zambeze River Wave Symbol inside shield */}
...
// Custom SVG Logo for MINEDH (Ministério da Educação e Desenvolvimento Humano)
const MinedhLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-emerald-500 fill-current" aria-label="MINEDH Logo">
    {/* Open Book and Rising Sun */}
    ...
    <text x="65" y="40" className="font-sans font-medium text-[7px] tracking-[0.05em] text-slate-400 uppercase">Ministério da Educação</text>
...
// Custom SVG Logo for FDC (Fundação para o Desenvolvimento da Comunidade)
const FdcLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-red-500 fill-current" aria-label="FDC Logo">
    ...
    <text x="65" y="44" className="font-sans font-bold text-[7px] tracking-[0.1em] text-slate-400 uppercase">Fundação para o Desenvolvimento</text>
    <text x="65" y="51" className="font-sans font-medium text-[6px] tracking-[0.1em] text-slate-500 uppercase">da Comunidade</text>
  </svg>
);

// Custom SVG Logo for ADEMO (Associação dos Deficientes de Moçambique)
const AdemoLogo = () => (
  <svg viewBox="0 0 200 60" className="w-full h-12 text-purple-500 fill-current" aria-label="ADEMO Logo">
    {/* Stylized Active Inclusivity Monogram (rising person in wheelchair/star) */}
    ...
    {/* Star shape indicating hope/rise */}
    ...
    <text x="62" y="43" className="font-sans font-bold text-[7px] tracking-[0.1em] text-slate-400 uppercase">Associação dos Deficientes</text>
    <text x="62" y="50" className="font-sans font-medium text-[6px] tracking-[0.1em] text-slate-500 uppercase">de Moçambique</text>
  </svg>
);
    ...
    <div className="w-full py-10 bg-slate-950/60 rounded-3xl border border-slate-800/80 px-6 backdrop-blur-sm">
      <div className="text-center mb-8 space-y-2">
        ...
        <h3 className="text-lg font-bold text-white tracking-tight">
          Instituições que Apoiam a Nossa Causa
        </h3>
